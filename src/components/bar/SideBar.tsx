...
export function SideBar() {
  ...
  return (
    <motion.div
      className={`z-40 fixed bg-background backdrop-blur rounded-r-3xl h-[100vh] flex flex-col justify-between`}
      initial={{ width: '3.5rem', opacity: 0 }}
      animate={{ width: !isCollapsed ? '3.5rem' : '15rem', opacity: 0.9 }}
